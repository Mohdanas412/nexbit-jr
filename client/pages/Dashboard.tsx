      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="inline-flex items-center gap-2 rounded-full bg-primary/10 dark:bg-primary/20 text-primary dark:drop-shadow-[0_0_4px_hsl(135_100%_40%)] px-3 py-1 text-sm font-semibold">
            <Sparkles className="w-4 h-4 dark:drop-shadow-[0_0_3px_hsl(135_100%_40%)]" />{" "}
            {greeting()}
          </p>
          ...
          <CardContent className="p-5">
            ...
            <div className="mt-3 space-y-2 text-sm">
              {["Aisha", "Leo", "Maya", "You", "Kai"].map((n, i) => (
                <div
                  key={n}
                  className={`rounded-lg p-2 flex items-center justify-between ${n === "You" ? "bg-primary/10 dark:bg-primary/20 border border-primary dark:border-primary/60 dark:shadow-[0_0_8px_hsl(135_100%_40%_/_0.3)] glow-soft" : "bg-muted dark:bg-[#1E1E2F]"}`}
                >
                  <span className="font-semibold flex items-center gap-2">
                    #{i + 1} {n}{" "}
                    {n === "You" && rankGlow && (
                      <Crown className="text-accent dark:drop-shadow-[0_0_6px_hsl(45_100%_50%)] animate-crown-glow" />
                    )}
                  </span>
