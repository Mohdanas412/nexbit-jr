...
import { CheckCircle2, Flame, Sparkles, Trophy, Users, Zap } from "lucide-react";
  ...
  return (
    <div>
        ...
        <div className="container py-16 grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            ...
            <h1 className="mt-4 text-4xl sm:text-5xl font-extrabold leading-tight tracking-tight">
              Make coding a habit.
              <br />
              <span className="text-primary">Learn step by step, playfully.</span>
            </h1>
            <p className="mt-4 text-lg text-muted-foreground max-w-xl">
              Nexbit Jr is your friendly coding sidekick. Short lessons, streaks, XP and badges keep you motivated every day.
            </p>
            ...
            <div className="mt-6 flex items-center gap-4 text-sm text-muted-foreground">
              <div className="inline-flex items-center gap-2"><Flame className="text-accent" /> Streaks</div>
              <div className="inline-flex items-center gap-2"><Trophy className="text-primary" /> Badges</div>
              <div className="inline-flex items-center gap-2"><Users className="text-secondary" /> Leaderboard</div>
            </div>
          </div>
      ...
      <section className="container py-14">
        <h2 className="text-2xl sm:text-3xl font-extrabold text-center">Built for daily progress</h2>
      ...
      <section className="container py-16 text-center">
        <h2 className="text-2xl sm:text-3xl font-extrabold">Start free. Go pro soon.</h2>
        <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">Free plan includes daily AI chat and limited lessons. Premium with unlimited chat and advanced challenges is coming soon.</p>
